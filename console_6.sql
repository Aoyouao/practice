...
values ('tom1',18,'1','男'),
       ('tom2',28,'0','男');
insert into user(name, age, status, gender) values('tom3',24,'1','男');
insert into user(name, age, status, gender) values('tom3',22,'1','男');

insert into user(name, age, status, gender) values('tom4',125,'1','男');
insert into user(name, age, status, gender) values('tom5',6,'1','男');

insert into user(name, age, gender) values('tom6',24,'男');
